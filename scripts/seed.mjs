...
const posts = [
  ...
  { title: "识别PUA话术：从入门到精通的防身手册", summary: "系统整理PUA常见话术套路，包括打压式社交、否定人格、制造依赖等。", sectionId: "awareness", tags: ["PUA", "防身术", "情感安全"], videoUrl: "https://www.youtube.com/watch?v=4zGBcPnI61I" },
  ...
  { title: "为什么饭局上最先买单的人，往往不是最有钱的", summary: "从社交心理学角度分析饭局买单行为背后的动机和社会信号。", sectionId: "social", tags: ["社交心理", "饭局文化", "行为分析"], isHot: true, isFeatured: true, videoUrl: "https://www.bilibili.com/video/BV1x54y1e7zf" },
  ...
  { title: "艾尔登法环DLC全流程无伤攻略｜附隐藏Boss位置", summary: "DLC《黄金树幽影》全Boss无伤打法详解，包含所有隐藏Boss位置和攻略路线。", sectionId: "gaming", tags: ["艾尔登法环", "攻略", "DLC"], isHot: true, isFeatured: true, videoUrl: "https://www.youtube.com/watch?v=OT8if6WBMB8" },
  { title: "2026年最值得入手的显卡推荐｜4060到4090全面对比", summary: "各价位段显卡性能横评，包含游戏实测帧数、功耗、性价比分析。", sectionId: "gaming", tags: ["显卡推荐", "硬件评测", "装机"], isFeatured: true, videoUrl: "https://www.youtube.com/watch?v=wnRqcEFBias" },
  ...
  { title: "原神5.0新版本深度评测：纳塔值得回坑吗？", summary: "从画面、玩法、氪金度三个维度深度评测原神纳塔版本。", sectionId: "gaming", tags: ["原神", "评测", "新版本"], videoUrl: "https://www.bilibili.com/video/BV1GJ411x7h7" },
  ...
  { title: "新手三大项突破指南：从空杆到100kg的12周计划", summary: "为健身新手设计的12周力量训练计划，目标深蹲/卧推/硬拉各100kg。", sectionId: "fitness", tags: ["新手指南", "三大项", "训练计划"], isHot: true, isFeatured: true, videoUrl: "https://www.youtube.com/watch?v=R6gZoAzAhCg" },
  ...
  { title: "体态纠正：办公族最常见的5种体态问题和解决方案", summary: "圆肩、骨盆前倾、头前伸...办公族必看的体态纠正训练。", sectionId: "fitness", tags: ["体态纠正", "办公族", "健康"], videoUrl: "https://www.youtube.com/watch?v=g-7ZWPCWv0U" },
  { title: "补剂红黑榜：哪些值得买，哪些是智商税", summary: "科学评测常见健身补剂，帮你把钱花在刀刃上。", sectionId: "fitness", tags: ["补剂评测", "科学健身", "避坑"], isHot: true },
  { title: "下班后靠这个副业月入8k，完整复盘和操作方法", summary: "分享我做自媒体副业的完整过程，从0到月入8k用了6个月。", sectionId: "finance", tags: ["副业", "自媒体", "实操分享"], isHot: true, isFeatured: true, videoUrl: "https://www.youtube.com/watch?v=snAhsXyO3Ck" },
